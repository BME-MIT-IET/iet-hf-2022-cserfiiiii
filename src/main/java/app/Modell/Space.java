...
public class Space implements Steppable {
	...
	private ArrayList<Creature> creatures; // az urben tartozkodo main.java.app.Modell.Creature-ok listaja
	...
	//hozzaadja a parameterkent megkapott main.java.app.Modell.Creature peldanyt az creatures listahoz
	public void AddCreature(Creature c) {
        creatures.add(c);
	}

	//kiveszi a parameterkent megkapott main.java.app.Modell.Creature peldanyt az creatures listabol

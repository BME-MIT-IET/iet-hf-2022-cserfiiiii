...
public class Asteroid implements Steppable, Transport {
	...
	private ArrayList<Creature> creatures;            	//Az aszteroidan talalhato main.java.app.Modell.Creature osztalybol szarmazo objektumok listaja.
	...
	public void AddCreature(Creature c) {   //Hozzaad egy main.java.app.Modell.Creature objektumot a creatures listahoz.
		creatures.add(c);
	}
	...
	public void RemoveCreature(Creature c) {  //Kivesz egy main.java.app.Modell.Creature objektumot a creatures listabol.
		creatures.remove(c);
	}

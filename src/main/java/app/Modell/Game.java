...
public class Game {
	...
	//kiveszi a steppable listahoz a parameterkent megkapott main.java.app.Modell.Steppable peldanyt
	public void RemoveSteppable(Steppable s) {
        steppable.remove(s);
	}
	
	//hozzáadja a steppable listahoz a parameterkent megkapott main.java.app.Modell.Steppable peldanyt

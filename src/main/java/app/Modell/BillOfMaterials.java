...
import java.util.ArrayList;
	...
	public class BillOfMaterials {
		...
		public boolean CheckMaterials(ArrayList<Material> materials) {
			...
			//Ha a main.java.app.Modell.BillOfMaterials materialListajabol az osszes alapanyag kitorlodott,
		...
		public void SetUpRobot() {
			...
			//A teszt folyaman a robot epitesehez egy main.java.app.Modell.Iron, egy main.java.app.Modell.Uranium es egy main.java.app.Modell.Carbon szukseges
		...
		public void SetUpGate() {
			...
			//A teszt folyaman a teleportkapu epitesehez egy main.java.app.Modell.Uranium, egy main.java.app.Modell.Ice es ket main.java.app.Modell.Iron szukseges
			//Ezekkel tolti fel a materialListet
			materialList.add(new Uranium());
			materialList.add(new Iron());
			materialList.add(new Iron());
